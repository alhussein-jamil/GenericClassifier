...
from src.schemas import DataConfig, Dataset
...
def create_data_generators(
    dataset: Dataset, config: DataConfig
    ...
    train_dataset = ImageDataset(
        images=dataset.train_images, num_classes=num_classes, transform=train_transform
    )

    val_dataset = ImageDataset(
        images=dataset.val_images, num_classes=num_classes, transform=val_transform
    )
...
class ImageDataset(TorchDataset):
    ...
    def __init__(self, images: list, num_classes: int, transform=None):
        """
