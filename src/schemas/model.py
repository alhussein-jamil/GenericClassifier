...
class TrainingHistory:
    ...
    val_accuracy: List[float] = field(default_factory=list)  # Validation accuracy per epoch
...
class Model:
    ...
    history: TrainingHistory = field(default_factory=TrainingHistory)  # Training history
